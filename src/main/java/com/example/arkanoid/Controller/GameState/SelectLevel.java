...
import com.example.arkanoid.Controller.Utils.AnimationGame;
...
public class SelectLevel {
    public void openLevelSelect(Stage stage, Scene menuScene, Arkanoid mainApp) throws IOException {
        ...
        LV1ImgV.setOnMouseClicked(e -> {
            ...
            BackgroundMusic lv1sound = new BackgroundMusic();
            BackgroundMusic.playBackgroundMusic("src/main/resources/com/example/arkanoid/sounds/gameMusic1.wav");
        ...
        LV2ImgV.setOnMouseClicked(e -> {
            ...
            BackgroundMusic.playBackgroundMusic("src/main/resources/com/example/arkanoid/sounds/gameMusic2.wav");
            StartLevel s1 = new StartLevel();
        ...
        LV3ImgV.setOnMouseClicked(e -> {
            ...
            BackgroundMusic.playBackgroundMusic("src/main/resources/com/example/arkanoid/sounds/gameMusic3.wav");
            StartLevel s1 = new StartLevel();
        ...
        LV4ImgV.setOnMouseClicked(e -> {
            BackgroundMusic.playBackgroundMusic("src/main/resources/com/example/arkanoid/sounds/gameMusic4.wav");
            StartLevel s1 = new StartLevel();
        ...
        LV5ImgV.setOnMouseClicked(e -> {
            BackgroundMusic.playBackgroundMusic("src/main/resources/com/example/arkanoid/sounds/gameMusic5.wav");
            StartLevel s1 = new StartLevel();
